...
import { CategoryMainFormComponent } from './dialogs/category-main-form/category-main-form.component';
import { CategoryMainDeleteComponent } from './dialogs/category-main-delete/category-main-delete.component';
...
export class CategoryTableComponent implements OnInit {
  ...
  addNew() {
    const dialogRef = this.dialog.open(CategoryMainFormComponent, {
      data: {
  ...
  deleteItem(row) {
    this.id = row.id;
    const dialogRef = this.dialog.open(CategoryMainDeleteComponent, {
      data: row
    });
    dialogRef.afterClosed().subscribe((result) => {
      if (result === 1) {
...
export class ExampleDataSource extends DataSource<Category> {
  ...
  constructor(
    public _exampleDatabase: CategoryService,
  ...
  connect(): Observable<Category[]> {
    ...
    this._exampleDatabase.getAllCategorys();
