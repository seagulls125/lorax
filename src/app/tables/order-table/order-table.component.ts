...
import { OrderDeleteComponent } from './dialogs/order-delete/order-delete.component';
...
export class OrderTableComponent implements OnInit {
    ...
    dialogRef.afterClosed().subscribe((result) => {
      if (result === 1) {
        ...
        this.exampleDatabase.dataChange.value.unshift(
          this.orderService.getDialogData()
        );
        this.refreshTable();
  ...
  // context menu
  onContextMenu(event: MouseEvent, item: Order) {
...
export class ExampleDataSource extends DataSource<Order> {
  ...
  renderedData: Order[] = [];
  constructor(
    public _exampleDatabase: OrderService,
